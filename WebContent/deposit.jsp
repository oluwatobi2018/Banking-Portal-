...
<div class="contain">
				...
				<div class="col-lg-6">
						<form action="AppServlet?id=update_deposit&cid=<%out.println(cid); %>" method="post">
							<p id="select">DEPOSIT:</p>
							...
							%>
							<font color="white" id="label">Deposit Amount: </font><input type="text" name="deposit_amt">
							<input type="submit" value"PROCESS DEPOSIT">
						</form>
				</div>
